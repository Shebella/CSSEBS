...
public class unittest_QueryEvent extends BasicUnitTestClass{
	private String account="User1";
	
	

	
	public unittest_QueryEvent(String account){
	   ...
	   public static Collection parameters() {
			...
			try {
				brf=new BufferedReader(new InputStreamReader(unittest_Existingevents.class.getClassLoader().getResourceAsStream("unittest_QueryEvent.txt")));
				String str=null;
...
/*	   @Parameterized.Parameters
	...
	public void testQueryEventBeforeInsertEvent() throws EBSException, SQLException, NamingException{
		...
		queryeventResponse rQuerye=ebs.queryevent(account, instanceid,new Long(rSync2.syncId).toString(),new Long(rSync.syncId).toString(),null);
	...
	public void testQueryEventAfertInert1Event() throws EBSException, SQLException, NamingException{	
		...
		queryeventResponse rQuerye=ebs.queryevent(account, instanceid,new Long(rSync3.syncId).toString(),new Long(rSync.syncId).toString(),null);
		assertTrue(rQuerye!=null);
		assertTrue(rQuerye.result);
	...
	public void testQueryEventBeforeGetlock() throws EBSException, SQLException, NamingException{
		...
		queryeventResponse rQuerye=ebs.queryevent(account, instanceid,new Long(rSync.syncId+1).toString(),new Long(rSync.syncId).toString(),null);
		assertTrue(rQuerye!=null);
