...
public class unittest_Unlock extends BasicUnitTestClass{
	


	private String account;

	public unittest_Unlock(String account){
	   ...
	   public static Collection parameters() {
			...
			try {
				brf=new BufferedReader(new InputStreamReader(unittest_Existingevents.class.getClassLoader().getResourceAsStream("unittest_Unlock.txt")));
				String str=null;
...
/*	   @Parameterized.Parameters
	...
	public void TestUnlockedwithSUCCStateBefore() throws SQLException, NamingException, EBSException{
		 ...
		 //unlock
		 unLockResponse ur2=this.ebs.unlock(account, instanceid1,"SUCCESS");
